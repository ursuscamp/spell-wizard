...
import type { DashboardView, HistoryView, Profile, RewardEvent, SessionRecord, WordProgress } from '../../shared/spelling'
...
export function buildDashboardView(profile: Profile, rewards: RewardEvent[], sessions: SessionRecord[], wordProgress: WordProgress[]): DashboardView {
  return {
    profile,
...
export function buildHistoryView(profile: Profile, rewards: RewardEvent[], sessions: SessionRecord[], wordProgress: WordProgress[]): HistoryView {
  return {
    profile,
